...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['name'], $_POST['email'], $_POST['phone'], $_POST['message'])) {
    ...
    if (!empty($user_id) && !empty($name) && !empty($email) && !empty($phone) && !empty($message)) {
...
<header>
    <nav class="navbar section-content">
        ...
        <ul class="nav-menu">
            ...
            <li class="nav-item">
                <a href="<?php echo isset($_SESSION['user_id']) ? 'logout.php' : 'login.php'; ?>" class="nav-link">
        ...
        <div class="section-content">
            <ul class="contact-info-list">
                <li class="contact-info">
                    ...
                    </i><p>Kamaladi, Kathmandu</p></li>
                <li class="contact-info">
                    <i class="fa-regular fa-envelope">
                    </i><p>glory@gmail.com</p></li>
                <li class="contact-info">
                    <i class="fa-solid fa-phone">
                    </i><p>+977-9813166771</p></li>
                <li class="contact-info">
...
function showPopup() {
    ...
    if (unreadMessages.length > 0) {
        let content = "";
        unreadMessages.reverse().forEach(msg => { // Reverse to show latest first
            content += `<p><strong>Admin Response:</strong> ${msg.response}</p>`;
            content += `<p><strong>Your Message:</strong> ${msg.message}</p><hr>`;
        });
